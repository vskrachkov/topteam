...
players_repository.save(Player('4d654ffe-b901-4cad-afc7-ebeb8cfa06a3', 'Bohdan Sheketa', defense=2, offense=3, team_play=3, physical=2, vision=2, mentality=1))
...
players_repository.save(Player('0d206713-915f-4d9f-92e1-8ad9d176a1de', 'Rudiy (Ihor)', defense=3, offense=4, team_play=2, physical=3, vision=3, mentality=2))
players_repository.save(Player('d021718e-33c0-4712-b4b4-2211d75edf77', 'Artur', defense=3, offense=2, team_play=3, physical=1, vision=3, mentality=2))
...
players_repository.save(Player('a2b04543-31b8-4d43-bf75-45f8b21f4eb5', 'Serhii (Artur)', defense=2, offense=3, team_play=2, physical=2, vision=3, mentality=3))
...
def main() -> None:
    ...
    players = players_repository.find_by_ids(
        [
            "7d536174-1763-4517-9960-7062d880145b",
            ...
            "a1014b25-ddd9-43ec-9d35-0614416661cb",
            "34542d1c-fb56-40d9-b13f-9cd97dd15ba0",
            "544489bf-2479-4be6-b3a2-0401815ae678",
            "d021718e-33c0-4712-b4b4-2211d75edf77",
            "8caa92a3-fd22-47e0-b798-799b8cb4bea9",
            "33a4b21b-785a-4943-9b1a-3ab4f72f7dce",
            "17ee46e2-5dd2-481a-97c7-e539393ebfc7",
            "6be22f3f-30a7-4afc-995c-f80a23c40b5a",
        ]
    )
    strategies = [
